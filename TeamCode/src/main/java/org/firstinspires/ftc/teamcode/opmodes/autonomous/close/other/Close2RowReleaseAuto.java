...
public class Close2RowReleaseAuto extends SequenceAuto {
    private static final AutoSpec SPEC = new AutoSpec(Range.CLOSE_RANGE, true, false, true, 1, 2);

    public Close2RowReleaseAuto(Alliance alliance) {
        super(alliance);
    }
