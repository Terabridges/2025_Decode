...
public class FarPreloadOnlyAuto extends SequenceAuto {
    private static final AutoSpec SPEC = new AutoSpec(Range.LONG_RANGE, false, false, true);

    public FarPreloadOnlyAuto(Alliance alliance) {
        super(alliance);
    }
