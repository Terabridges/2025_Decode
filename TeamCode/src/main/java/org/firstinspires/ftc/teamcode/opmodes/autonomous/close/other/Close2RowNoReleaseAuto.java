...
public class Close2RowNoReleaseAuto extends SequenceAuto {
    private static final AutoSpec SPEC = new AutoSpec(Range.CLOSE_RANGE, false, false, true, 1, 2);

    public Close2RowNoReleaseAuto(Alliance alliance) {
        super(alliance);
    }
