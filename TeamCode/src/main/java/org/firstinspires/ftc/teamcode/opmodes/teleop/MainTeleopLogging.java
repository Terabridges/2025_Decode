...
//    }
    ...
    public void runOpMode(){
        ...
        try {
            ...
            org.psilynx.psikit.ftc.wrappers.MotorWrapper.setEncoderSkippedMotors(
                    "left_front", "left_back", "right_front", "right_back",
                    "spinner"
            );

                // If any motor velocity is being logged, sample at ~50Hz to reduce read cost.
                org.psilynx.psikit.ftc.wrappers.MotorWrapper.velocityRefreshPeriodSec = 0.02;

            Robot robot = new Robot(hardwareMap, telemetry, gamepad1, gamepad2);

            driveControl = new DriveControl(robot.drive, gamepad1, gamepad2);
            intakeControl = new IntakeControl(robot.intake, gamepad1, gamepad2);
            shooterControl = new ShooterControl(robot.shooter, gamepad1, gamepad2);
            transferControl = new TransferControl(robot.transfer, gamepad1, gamepad2);
            visionControl = new VisionControl(robot.vision, gamepad1, gamepad2);
