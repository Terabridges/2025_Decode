...
public class Close1RowNoReleaseAuto extends SequenceAuto {
    private static final AutoSpec SPEC = new AutoSpec(Range.CLOSE_RANGE, false, false, true, 1);

    public Close1RowNoReleaseAuto(Alliance alliance) {
        super(alliance);
    }
