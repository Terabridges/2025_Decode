...
public class Robot {
    ...
    public Other other;
    public GoalTagRelocalization relocalization;
    ...
    public Robot(HardwareMap hardwareMap, Telemetry telemetry, Gamepad gp1, Gamepad gp2){
        ...
        relocalization = new GoalTagRelocalization(intake, outtake);

        subsystems = new ArrayList<>(Arrays.asList(intake, outtake, other, relocalization));
...
//    }
    ...
    public void update() {
        ...
        boolean relocalizationLightsActive = relocalization != null && relocalization.isControllingLights();
        if (txLights && !relocalizationLightsActive){
