...
class MainAutoPsikit extends PsiKitIterativeOpMode {
    ...
    MainAutoPsikit(Alliance alliance, Range range, Mode mode) {
        this(alliance, range, mode, ShotPlan.ALL_SELECTED);
    }

    MainAutoPsikit(Alliance alliance, Range range, Mode mode, ShotPlan shotPlan) {
        this(alliance, range, mode, shotPlan, true);
    }

    MainAutoPsikit(Alliance alliance, Range range, Mode mode, ShotPlan shotPlan, boolean releaseAfterClosePickup) {
