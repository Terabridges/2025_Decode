...
public class AutoPoses {
    ...
    public Pose row2ShootCloseB = poseDeg(55.0, 96.0, 0.0);
    public Pose row2ShootCloseR = poseDeg(FIELD_SIZE - row2ShootCloseB.getX(), row2ShootCloseB.getY(), 0.0);
    public Pose finalShootCloseB = poseDeg(49.0, 120.0, 0.0);
    public Pose finalShootCloseR = poseDeg(FIELD_SIZE - finalShootCloseB.getX(), finalShootCloseB.getY() - 5.0, 310.0);
    ...
    // ===== Release Poses =====
    public Pose releaseGoToCloseB = poseDeg(33.5, 66.0, 180.0);
    ...
    public Pose releaseCompleteCloseR = poseDeg(124.0, releaseCompleteCloseB.getY() + 5.0, 180.0);

    // ===== Leave Poses =====
    public Pose leaveCB = finalShootCloseB;
    public Pose leaveLB = poseDeg(25.0, 15.0, 0.0);
    public Pose leaveCR = finalShootCloseR;
    public Pose leaveLR = poseDeg(FIELD_SIZE - leaveLB.getX(), leaveLB.getY(), 0.0);

    // ===== Pickup Start Poses =====
    public Pose pick1StartCB = poseDeg(44.0, 84.0, 0.0);
    public Pose pick1StartCR = poseDeg(FIELD_SIZE - pick1StartCB.getX(), pick1StartCB.getY(), 0.0);
    ...
    public Pose pick3StartLB = poseDeg(44.0, 38.5, 0.0);
    ...
    public Pose backRowLoopCompletePickup1B = poseDeg(12.5, 38.0, 90.0);
    public Pose backRowLoopCompletePickup1R = mirrorBluePose(backRowLoopCompletePickup1B);
    public Pose backRowLoopCompletePickup1ControlB = poseDeg(12.5, 4.0, 0.0);
    public Pose backRowLoopCompletePickup1ControlR = mirrorBluePose(backRowLoopCompletePickup1ControlB);
    public Pose backRowLoopGoToShootControlB = poseDeg(12.5, 20.0, 0.0);
    public Pose backRowLoopGoToShootControlR = mirrorBluePose(backRowLoopGoToShootControlB);
    ...
    public Pose row4CompletePickupControlB = poseDeg(19.25, 11.5, 0.0);
    ...
    public Pose row4CompletePickupB = poseDeg(11.5, 9.0, 0.0);
    ...
    public Pose closeLoopPickupR = poseDeg(131.0, 59.0, 28.0);
    ...
    public Pose closeLoopCompletePickupR = poseDeg(130.0, 61.0, 28.0);
    ...
    // ===== Pickup End Poses =====
    public Pose pick1EndCB = poseDeg(24.0, 84.0, 0.0);
    public Pose pick1EndCR = poseDeg(FIELD_SIZE - pick1EndCB.getX(), pick1EndCB.getY(), 0.0);
    ...
    public Pose pick3EndLB = poseDeg(24.0, 38.5, 0.0);
    ...
    public Pose pick4EndLB = poseDeg(11.75, 8.5, 0.0);
    ...
    public Pose getBackRowLoopGoToShootControl(Alliance a) {
        return (a == Alliance.BLUE) ? backRowLoopGoToShootControlB : backRowLoopGoToShootControlR;
    }
