...
class MainAutoLogging extends LinearOpMode {
    ...
    MainAutoLogging(Alliance alliance, Range range, Mode mode) {
        this(alliance, range, mode, ShotPlan.ALL_SELECTED);
    }

    MainAutoLogging(Alliance alliance, Range range, Mode mode, ShotPlan shotPlan) {
        this(alliance, range, mode, shotPlan, true);
    }

    MainAutoLogging(Alliance alliance, Range range, Mode mode, ShotPlan shotPlan, boolean releaseAfterClosePickup) {
