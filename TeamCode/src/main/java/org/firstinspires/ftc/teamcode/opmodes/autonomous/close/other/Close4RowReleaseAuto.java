...
public class Close4RowReleaseAuto extends SequenceAuto {
    private static final AutoSpec SPEC = new AutoSpec(Range.CLOSE_RANGE, true, false, true, 1, 2, 3, 4);

    public Close4RowReleaseAuto(Alliance alliance) {
        super(alliance);
    }
