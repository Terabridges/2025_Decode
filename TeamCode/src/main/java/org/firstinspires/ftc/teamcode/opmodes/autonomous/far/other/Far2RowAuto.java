...
public class Far2RowAuto extends SequenceAuto {
    private static final AutoSpec SPEC = new AutoSpec(Range.LONG_RANGE, false, false, true, 4, 3);

    public Far2RowAuto(Alliance alliance) {
        super(alliance);
    }
