...
public class Close4RowNoReleaseAuto extends SequenceAuto {
    private static final AutoSpec SPEC = new AutoSpec(Range.CLOSE_RANGE, false, false, true, 1, 2, 3, 4);

    public Close4RowNoReleaseAuto(Alliance alliance) {
        super(alliance);
    }
