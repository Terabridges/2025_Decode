...
public class ClosePreloadOnlyNoReleaseAuto extends SequenceAuto {
    private static final AutoSpec SPEC = new AutoSpec(Range.CLOSE_RANGE, false, false, true);

    public ClosePreloadOnlyNoReleaseAuto(Alliance alliance) {
        super(alliance);
    }
