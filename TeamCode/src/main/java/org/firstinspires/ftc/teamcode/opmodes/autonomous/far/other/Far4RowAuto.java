...
public class Far4RowAuto extends SequenceAuto {
    private static final AutoSpec SPEC = new AutoSpec(Range.LONG_RANGE, false, false, true, 4, 3, 2, 1);

    public Far4RowAuto(Alliance alliance) {
        super(alliance);
    }
