...
public class Close3RowNoReleaseAuto extends SequenceAuto {
    private static final AutoSpec SPEC = new AutoSpec(Range.CLOSE_RANGE, false, false, true, 1, 2, 3);

    public Close3RowNoReleaseAuto(Alliance alliance) {
        super(alliance);
    }
